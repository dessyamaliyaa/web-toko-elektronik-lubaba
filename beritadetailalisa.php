...
<div class="format-standard">
  <div class="span4">
	<a>
		<img style="width: 640px; height: 240px; float:left; margin-right:10px;" <img src="images/perusahaanbaik.jpg">	</a>
	</div><br>
	
    <div class="box cf">
	<br>
		<div class="excerpt">
      <div class="content-heading"><h2>Perusahaan Ini Janjikan Gaji Rp 113 Juta</h2></div><br>
      <p><a href="#" class="btn btn-inverse">Diposkan pada 2017-04-07</a> </p>
...
Tak perlu khawatir merasa kesepian saat bekerja. Mereka yang terpilih nanti juga bisa mengajak teman travelling seperti sahabat, keluarga, atau pasangan.</p>
    ...
    <ul class="nav nav-list">
        ...
        <ul type="square">
        	<li><a href='detailberita.php?ID_BERITA=3'>Perusahaan Ini Janjikan Gaji Rp 113 Juta</a></li><li><a href='detailberita.php?ID_BERITA=2'>Program Beasiswa METRODATA</a></li>        </ul>
    </ul>
</div><!--/.well ko-->
