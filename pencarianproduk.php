        	...
        	<div id="portfolio-content" class="cf">  
				...
				<ul id="filter-buttons">
                    ...
                    <div  align="right">
									<form method="GET" action="pencarianproduk.php" enctype="multipart/form-data">
                                                                            <input class="search" type="text" name="search" style="width: 200px" placeholder="Or Search Here">&nbsp;&nbsp;<input type="submit" value="Search" style="width: 100px"/>
				...
				<div id="filter-container" class="cf">
						...
						include "koneksi.php";
                                                ...
                                                $search = $_GET ['search'];
						$query = "SELECT * FROM produk WHERE nama LIKE '%$search%' ORDER BY id DESC"; // Query untuk menampilkan semua data produk
