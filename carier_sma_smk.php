			...
			<div class="wrapper cf">
	        	...
	        	<div id="posts-list" class="cf">   
					...
					<?php
						...
						$query = ("SELECT * from carier where jenjang = 'sma / smk' order by date_post desc limit $star, $perPages");
					  ...
					  <article class="format-standard">
							...
							<div class="box cf">
								...
								<div class="excerpt">
									...
									<p>Lowongan ini berahir pada <?php  echo $row["AKHIR_REQ"];?></p>
									<p>Gaji sebesar <?php  echo "Rp ", rupiah($row["GAJI"], 2);?></p>
